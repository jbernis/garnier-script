#!/usr/bin/env python3
"""
Script pour afficher toutes les informations d'un produit Cristel spécifique.
"""
...
def get_product_info(product_code):
    ...
    print("=" * 80)
    print(f"🔍 RECHERCHE DU PRODUIT CRISTEL: {product_code}")
    print("=" * 80)
...
def show_stats():
    ...
    print("=" * 80)
    print("📊 STATISTIQUES GLOBALES - CRISTEL")
    print("=" * 80)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Affiche les informations d\'un produit Cristel ou les statistiques globales'
    )
    parser.add_argument(
        'product_code',
        nargs='?',
