...
def collect_from_subcategory_url(subcategory_url, category, subcategory_name, output_db='artiga_products.db', headless=True, driver=None, session=None):
    """
    ...
    try:
        ...
        # Utiliser la fonction get_products_from_subcategory du scraper existant
        ...
        for idx, product_info in enumerate(products, 1):
            product_code = product_info.get('code', f'ARTIGA-{idx}')
