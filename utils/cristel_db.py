"""
Module de gestion de la base de données SQLite pour le scraper Cristel.
"""
...
class CristelDB:
    """Gestionnaire de base de données pour les produits Cristel."""
    
    def __init__(self, db_path: str = "cristel_products.db"):
    ...
    def _init_db(self):
        ...
        self.conn.commit()
        logger.info(f"Base de données Cristel initialisée: {self.db_path}")
    ...
    def get_completed_products(self, categories: List[str] = None, subcategory: str = None, subcategories: List[str] = None, exclude_errors: bool = False) -> List[Dict]:
        ...
        if subcategories and len(subcategories) > 0:
            ...
            conditions.append(f"p.subcategory IN ({placeholders})")
    ...
    def get_category_stats(self, category: str) -> Dict:
        ...
        Pour Cristel, 'category' correspond en réalité à une sous-catégorie.
    ...
    def delete_all(self) -> int:
        ...
        self.conn.commit()
        logger.info(f"Base de données Cristel vidée: {count} produits supprimés")
